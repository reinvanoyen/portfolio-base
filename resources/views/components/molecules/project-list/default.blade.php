<div class="project-list">
    ...
    <div class="project-list__col project-list__col--first">
        <ul class="project-list__list">
            ...
            <li>
                <a href="https://www.art-of-building.be" title="www.art-of-building.be" target="_blank">
                    www.art-of-building.be
                </a>
            </li>
            <li>
                <a href="https://www.depuydthaarden.be" title="www.depuydthaarden.be" target="_blank">
            ...
            <li>
                <a href="https://www.charlottepringels.be" title="www.charlottepringels.be" target="_blank">
                    www.charlottepringels.be
                </a>
            </li>
            <li>
    ...
    <div class="project-list__col project-list__col--last">
        <ul class="project-list__list">
            ...
            <li>
                <a href="https://www.bram9000.be" title="www.bram9000.be" target="_blank">
                    www.bram9000.be
                </a>
            </li>
            <li>
